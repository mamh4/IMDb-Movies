...
#source("../scripts/cleaning_functions/clean_dob.R")
...
```
Since the data is spanning years since the 1900s we thought that including population and Consumer Price Index is crucial for drawing meaningful conclusions.
