...
movies |> distinct(title, year, .keep_all = TRUE) |>
  ...
  labs(y="Estimated Total Tickets Sold", 
       ...
       subtitle = "Perturbations during WWII (1936-1945) and Covid-19 (2020-2022)")+
  theme_minimal()
