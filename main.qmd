...
base_url <- 'https://www.imdb.com/search/title/?title_type=feature&num_votes=5000,&sort=user_rating,desc&ref_=adv_prv'
urls <- list(base_url)
...
# Send an HTTP GET request
url <-
  'https://www.imdb.com/search/title/?title_type=feature&num_votes=5000,&sort=user_rating,desc&start=9101&ref_=adv_nxt'
...
for (i in seq(1, 100)) {
  ...
  #if (is_first_page) {
  #  url <-
  #    'https://www.imdb.com/search/title/?title_type=feature&num_votes=10000,&sort=user_rating,desc#&start=51&ref_=adv_nxt'
  #  is_first_page <- FALSE
  #}
  #else {
    #url_xpath <- '//*[@id="main"]/div/div[1]/div[2]'
    #browser()
    
    #if (page |> html_nodes(xpath = '//*[@id="main"]/div/div[1]/div[2]/a') |> html_text() == 'Next »') {
    #  url_xpath <- '//*[@id="main"]/div/div[1]/div[2]/a'
    #}
...
save(movies, file = "data/data.RData")
